...
def main() -> None:
    ...
    keep = [
        ...
        "per_host_installed_cpu_server_groups",
        "per_host_realized_average_required_gpu_server_groups",
        "per_host_realized_average_required_cpu_server_groups",
        "installed_gpu_capacity_to_average_local_demand_ratio",
        "installed_cpu_capacity_to_average_local_demand_ratio",
        "installed_total_server_capacity_to_average_local_demand_ratio",
        "realized_total_installed_capacity_utilization_fraction",
        "realized_total_capacity_redundancy_fraction_above_average",
